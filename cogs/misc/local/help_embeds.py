...
def main_help_embed(bot: commands.Bot) -> discord.Embed:
	...
	embed.add_field(name = "```👥 Multiplayer```", value = "Category centered in multiplayer interactions and games.", inline = False)
...
#***************************************************************************************************
def multiplayer_help_embed(bot: commands.Bot) -> discord.Embed:
	embed = discord.Embed(
		title = "👥 Multiplayer Category",
		description = "Category centered in multiplayer interactions and games.",
		color = discord.Colour.green()
	)
	embed.add_field(name = "", value = "```🛠️ Commands 🛠️```", inline = False)
	embed.add_field(
